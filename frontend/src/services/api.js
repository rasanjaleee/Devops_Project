...
const API = axios.create({
  baseURL: "http://3.111.65.213:5000/api",
  timeout: 10000,
});
...
export const createWorkshop = (workshopData) =>
  API.post("/workshops", workshopData);
export const updateWorkshop = (id, workshopData) =>
  API.put(`/workshops/${id}`, workshopData);
...
export const getFeaturedWorkshops = async () => {
  try {
    ...
    console.error(
      "API Error - getFeaturedWorkshops:",
...
export const getWorkshopsWithFilters = async (filters = {}) => {
  try {
    ...
    console.error(
      "API Error - getWorkshopsWithFilters:",
      error.response?.data || error.message,
    );
    throw error;
  }
...
export const getWorkshopsByCategory = async (category, filters = {}) => {
  try {
    ...
    console.error(
      "API Error - getWorkshopsByCategory:",
      error.response?.data || error.message,
    );
    throw error;
  }
...
export const getHomepageData = async () => {
  try {
    ...
    const result = {
      featuredWorkshops:
        featuredResponse.status === "fulfilled" ? featuredResponse.value : null,
      categories:
...
export const getEnrollmentByWorkshop = async (workshopId) => {
  try {
    ...
    console.error(
      "API Error - getEnrollmentByWorkshop:",
      error.response?.data || error.message,
    );
    throw error;
  }
...
export const updateEnrollmentProgress = async (
  ...
  try {
    ...
    console.error(
      "API Error - updateEnrollmentProgress:",
      error.response?.data || error.message,
    );
    throw error;
  }
